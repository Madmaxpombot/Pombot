...
DEFAULT_PASS = os.getenv("ADMIN_PASS", "madmax")
...
<head>
    ...
    <style>
        ...
        /* Mobile drawer fix: independent of Tailwind transforms */
        #sidebar {
            position: fixed;
            top: 0;
            left: 0;
...
<body class="text-slate-100 min-h-screen flex">
                        ...
                        <table class="w-full text-left text-xs font-mono text-slate-300">
                            <thead class="text-purple-400 uppercase text-[10px] border-b border-purple-900/40">
                                <tr>
                                    ...
                                    <th class="p-2.5">Validity</th>
                                    <th class="p-2.5">Link</th>
                            ...
                            <tbody class="divide-y divide-purple-900/30">
                                ...
                                <tr>
                                    <form method="POST" action="/admin/plans/update">
                                        ...
                                        <td class="p-2.5 text-cyan-400">{{ pid }}</td>
                                        <td class="p-2.5"><input type="text" name="name" value="{{ name }}" class="bg-[#070410] border border-purple-900/60 rounded px-2 py-1 text-white"></td>
                                        <td class="p-2.5"><input type="number" step="any" name="amount" value="{{ amount }}" class="bg-[#070410] border border-purple-900/60 rounded px-2 py-1 text-white w-20"></td>
                                        <td class="p-2.5"><input type="text" name="validity" value="{{ validity }}" class="bg-[#070410] border border-purple-900/60 rounded px-2 py-1 text-white w-24"></td>
                                        <td class="p-2.5"><input type="text" name="access_link" value="{{ access_link }}" placeholder="https://t.me/+..." class="bg-[#070410] border border-purple-900/60 rounded px-2 py-1 text-white w-32"></td>
                                        <td class="p-2.5 text-right space-x-1">
                                            <button type="submit" class="bg-purple-900/60 px-2 py-1 rounded text-[10px] font-tech text-white">UPDATE</button>
                                    </form>
                                            <form method="POST" action="/admin/plans/delete" onsubmit="return confirm('Delete plan?');" class="inline">
                                                <input type="hidden" name="plan_id" value="{{ pid }}">
                                                <button type="submit" class="bg-rose-500/20 text-rose-400 px-2 py-1 rounded text-[10px] font-tech">DEL</button>
                                            </form>
                                        </td>
                                </tr>
                                {% endfor %}
    ...
    <script>
        ...
        function switchTab(tabId) {
            ...
            // Automatically close drawer on mobile after clicking
        ...
        (function() {
            ...
            var cleanExpiry = rawExpiry ? rawExpiry.replace(' ', 'T') : "";
            var expiryDate = cleanExpiry ? new Date(cleanExpiry).getTime() : NaN;
